...
class _AddAnnouncementSheetState extends State<AddAnnouncementSheet> {
  ...
  String _selectedTruck = 'GAZelle';
  String _selectedCapacity = '1.5 tonna';

  final _trucks = ['GAZelle', 'Labo', 'Kamaz', 'Zil', 'Boshqa'];
  final _capacities = ['0.5 tonna', '1 tonna', '1.5 tonna', '3 tonna', '5 tonna', '10+ tonna'];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _field("Narxi (so'm)", '200 000', _priceCtrl, Icons.payments_outlined, isNumber: true),
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text("E'loningiz joylashtirildi!", style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
